...
const ZONES = [
  ['Lyon', ['lyon', 'villeurbanne', 'ecully', 'écully', 'vaulx-en-velin', 'venissieux', 'vénissieux', 'sassenage', 'saint-priest']],
  ['Marseille / Aix', ['marseille', 'aix-en-provence', 'aix en provence', 'toulon']],
  ['Toulouse', ['toulouse', 'blagnac', 'colomiers', 'labege', 'labège', 'balma']],
  ['Bordeaux', ['bordeaux', 'merignac', 'mérignac', 'pessac', 'le haillan', 'talence', 'bruges']],
  ...
  ['Nantes', ['nantes', 'saint-herblain', 'orvault', 'vertou']],
  ['Strasbourg', ['strasbourg', 'schiltigheim', 'mulhouse']],
  ['Rennes', ['rennes', 'cesson-sevigne', 'cesson-sévigné', 'brest', 'guipavas', 'lorient', 'quimper', 'saint-gregoire', 'saint-grégoire']],
  ['Nice / Sophia', ['nice', 'sophia antipolis', 'antibes', 'cannes']],
  ['Montpellier', ['montpellier', 'nimes', 'nîmes', 'perpignan', 'perols', 'pérols']],
  ['Grenoble', ['grenoble', 'meylan', 'chambery', 'chambéry', 'annecy', 'valence', 'seyssinet-pariset', 'echirolles', 'échirolles']],
  ['Rouen / Le Havre', ['rouen', 'le havre', 'caen', 'bois-guillaume', 'ifs']],
  ['Est (Nancy, Metz, Dijon, Besançon)', ['nancy', 'metz', 'dijon', 'besancon', 'besançon', 'reims', 'troyes', 'bezannes']],
  ['Val de Loire (Tours, Orléans, Angers, Le Mans)', ['tours', 'joue les tours', 'joué-lès-tours', 'orleans', 'orléans', 'angers', 'le mans', 'blois', 'chartres', 'ecouflant', 'écouflant', 'saran']],
